...
public class Driver {
    ...
    //    getDriver() is used to instantiate the driver object getDriver(), sürücü nesnesini başlatmak için kullanılır-
...
//         driver = WebDriverManager.chromedriver().create(); //selenium 4.5'den sonrasında böyle kullanılıyor
 ...
 /*
      ...
      WebDriverManager.chromedriver().setup(); ve
      driver = new ChromeDriver(); bu ikisin'in yerine yukardaki tek satırda yazmak yeterli  //selenium 4.5'den oncesinde böyle kullanılıyor
*/
        }
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
        driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(30)); //page'in load olmasını beklemek icin
