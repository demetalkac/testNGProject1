...
//CONSTRUCTOR
    ...
    //===============Getting the number of columns in a specific single row-exceldeki toplam sutun sayısını return eder.
    public int columnCount() {
        //getting how many numbers in row 1
        return workSheet.getRow(0).getLastCellNum();
    }
    //===============how do you get the last row number?Index start at 0.--exceldeki satır sayısını return eder
    public int rowCount() {
        return workSheet.getLastRowNum() + 1; }//adding 1 to get the actual count

    //==============When you enter row and column number, then you get the data--Satır ve sutun numaraları girildiginde hucredeki dataları verir
    ...
    // --Exceldeki dataları two dimentional array olarak alır(baslık dahil alır).
    ...
    //=========When you enter the row and column number, returning the value/ 3 parametre alır;deger,satır,sutun girildiginde o satır ve sutuna girilen veriyi ekler===============//
...
// Bu method ustteki methodla birlikte caısır.Overload eder.Parametreleri farklıdır(string,string,int).
    ...
    //Exceldeki dataları baslıksız olarak 2 boyutlu array seklinde return eder.
